package com.telcel.ractivador.utils;
...
public class Autoupdater {
    ...
    public boolean isNewVersionAvailable() {
        ...
        return Double.parseDouble(getLatestVersionName()) > Double.parseDouble(getCurrentVersionName());
    }
    ...
    private AsyncTask<String, Integer, Intent> downloadInstaller = new AsyncTask<String, Integer, Intent>() {
        ...
        protected Intent doInBackground(String... strings) {
            try {
                ...
                file.mkdirs();
                File outputFile = new File(file, "activador.apk");
                ...
                intent.setDataAndType(Uri.fromFile(new File(Environment.getExternalStorageDirectory() + "/download/" + "activador.apk")), "application/vnd.android.package-archive");
